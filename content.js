...
const PERSONS = [
  ...
  { name:"Faust", desc:"Sinner pertama yang bergabung dengan Limbus Company, sekaligus yang paling misterius di antara dua belas Sinner lainnya. Dialah yang merancang mesin bus Mephistopheles, dan senjatanya sendiri bernama Walpurgisnacht — dua referensi langsung ke 'Faust' karya Goethe.", cantos:["prologue","intervallo1","canto7"], profileKey:"faust" },
...
const SINNER_PROFILES = {
  "dante": {
    ...
    traits: "Tenang dan jarang meledak-ledak, cenderung jadi pendengar sebelum bertindak. Ingatan dan wajahnya sendiri sudah dihapus, tapi justru dari kekosongan itu dia belajar membaca orang lain dengan sangat peka — kemampuan yang secara harfiah bertumbuh jadi kekuatan barunya di Canto V, membaca pikiran dan keinginan orang lain lewat jam prostetiknya.",
    towardOthers: "Dante nyaris tidak pernah memerintah para Sinner secara langsung. Polanya selalu sama: hadir, mendengarkan, lalu bertanya pertanyaan yang tepat pada momen yang tepat — dia yang mengonfrontasi perasaan Yi Sang secara langsung di Canto IV (atas permintaan Hong Lu), dan yang meyakinkan Ishmael untuk menentukan takdirnya sendiri alih-alih dibiarkan sendirian menghadapi Ahab di Canto V.",
    relationships: "Dipercaya secara bertahap oleh hampir semua Sinner, meski identitas aslinya sendiri masih misteri penuh bagi mereka. Gregor secara sukarela melindunginya di Canto I meski dirinya sendiri baru saja hancur ulang oleh trauma masa kecilnya; Hong Lu mempercayakan Dante untuk turun tangan langsung ke Yi Sang yang sedang di titik terendah.",
    innerConflict: "Dia memimpin dan jadi sandaran emosional bagi sebelas orang lain, sementara dirinya sendiri tidak tahu siapa dirinya yang sebenarnya. Setiap kali dia membantu seorang Sinner menghadapi masa lalunya, dia melakukannya tanpa punya masa lalu sendiri untuk dijadikan pegangan.",
    values: "Kepercayaan dibangun lewat konsistensi tindakan, bukan lewat karisma atau kata-kata besar. Kepemimpinan sejati, baginya, adalah soal terus hadir untuk orang lain — bahkan ketika dirinya sendiri belum sepenuhnya utuh.",
    certainty: "mixed"
  },
  "faust": {
    literaryOrigin: "Johann Wolfgang von Goethe — 'Faust'. Ini referensi yang cukup solid dibuktikan lewat lebih dari sekadar nama: bus yang dia rancang sendiri mesinnya diberi nama Mephistopheles (tokoh iblis yang menggoda Faust dalam legenda aslinya), dan senjatanya sendiri bernama Walpurgisnacht — malam pesta para penyihir dalam 'Faust, Part One', titik ketika Mephistopheles menuntun Faust semakin dalam ke jalan yang gelap.",
    arcSummary: "Faust adalah Sinner pertama yang bergabung dengan Limbus Company — dialah yang merekrut para Sinner lain dan membangun Mephistopheles bahkan sebelum Dante terbangun sebagai 'kepala jam'. Sejauh cerita yang sudah terungkap, dia selalu berperan sebagai sosok yang menjelaskan — mekanisme telepati para Sinner di Prolog, cara kerja Distortion di Intervallo I — tapi identitas dan masa lalunya sendiri sengaja tidak pernah diungkap. Persis seperti tokoh Faust dalam legenda aslinya yang haus akan pengetahuan, Sinner ini tampaknya tahu jauh lebih banyak dari siapa pun di LCB, tapi harga dari pengetahuan itu belum pernah dijelaskan.",
    traits: "Tenang, penuh pengetahuan, dan selalu jadi orang yang menjelaskan sesuatu yang rumit ke orang lain dengan sabar — tapi nyaris tidak pernah membicarakan dirinya sendiri.",
    towardOthers: "Faust cenderung mengambil peran sebagai penjelas dan penenang, bukan pemberi perintah. Di Prolog, dialah yang menjelaskan ke Dante bahwa dia bisa berbicara lewat pikiran ke para Sinner; di Intervallo I, dialah yang menjelaskan apa itu Distortion dan mengusulkan solusi lewat kompetisi memasak alih-alih kekerasan.",
    relationships: "Hubungannya dengan tim LCB sebenarnya mendahului cerita ini sendiri — dia yang merekrut mereka semua. Di Canto VII, dia menunjukkan kepeduliannya secara konkret dengan berjanji mengambil tanggung jawab penuh, seandainya Sancho suatu hari mengetahui seluruh rencana P Corp terhadap ayahnya sendiri.",
    innerConflict: "Dia selalu jadi sosok yang memberi jawaban dan penjelasan untuk orang lain, sementara pertanyaan tentang siapa dirinya sendiri justru sengaja dia biarkan tak terjawab — pengetahuan yang dia bagikan begitu luas, tapi pengetahuan tentang dirinya sendiri dia jaga serapat mungkin.",
    values: "Pengetahuan datang bersama tanggung jawab — karena dialah yang paling banyak tahu, dialah juga yang paling sering memilih menanggung beban menjelaskan atau menanggung akibat, alih-alih menghindarinya.",
    certainty: "canon"
  },
  "canto1": {
    ...
    traits: "Pendiam dan menahan amarah dalam-dalam alih-alih meluapkannya, tetapi keras kepala secara diam-diam — penolakannya memotong sebutir apel selama bertahun-tahun adalah bukti kecil dari kekuatan mentalnya. Sangat protektif terhadap siapa pun yang dia lihat berada di posisi serupa dengan dirinya dulu.",
    towardOthers: "Gregor tidak suka berbasa-basi dan lebih memilih tindakan langsung dibanding kata-kata penenang. Begitu misi pertama LCB gagal total dan Vergilius memarahi Dante, dia secara sukarela maju mengambil alih tanggung jawab — tidak tega membiarkan Dante yang masih canggung menanggungnya sendirian.",
    relationships: "Ikatan terkuatnya di Canto I justru terjalin dengan Yuri, sesama korban Wing yang runtuh — dia melihat begitu banyak dirinya sendiri dalam diri Yuri, sampai tidak sanggup membunuh Abnormality yang mengambil wujud kepala Yuri. Di Intervallo I, dia terlihat lebih santai, bertengkar kecil dengan Ryoshu yang terasa akrab, bukan bermusuhan.",
    innerConflict: "Antara menjadi alat/instrumen bagi kepentingan orang lain (Old G Corp, bahkan ibunya sendiri) melawan usahanya mempertahankan otonomi sekecil apa pun atas tubuh dan pilihannya sendiri — pertentangan yang bahkan tergambar lewat lengannya sendiri, hasil operasi paksa yang terus dia gunakan tiap hari.",
    values: "Penolakan terhadap objektifikasi diri: bahkan tindakan diam dan menolak sekalipun adalah bentuk perlawanan yang sah, dan tanggung jawab terhadap orang lain lebih penting daripada membiarkan diri sendiri larut dalam trauma pribadi.",
    certainty: "canon"
  },
  "canto2": {
    ...
    traits: "Idealis yang mudah terluka oleh ketidakadilan di sekitarnya, tidak sabar pada diskusi panjang tanpa tindakan nyata, dan menyimpan rasa bersalah yang dia bawa diam-diam bahkan setelah bergabung dengan LCB.",
    towardOthers: "Rodion jujur secara blak-blakan, bahkan pada dirinya sendiri — dia berbohong soal masih punya sisa wish power demi misi tim, bukan demi kepentingan pribadinya. Dia tidak banyak berbasa-basi sosial dengan sesama Sinner, lebih menunjukkan dirinya lewat tindakan konkret saat tim membutuhkannya.",
    relationships: "Ikatan personalnya yang paling menentukan justru dengan tokoh di luar LCB: Sonya, sesama pendiri Yurodiviye yang jadi cermin dari jalan hidup yang dia tinggalkan. Di dalam tim sendiri, dia berpartisipasi penuh melumpuhkan penyerang bersama para Sinner lain begitu Golden Bough dalam bahaya — tanda kesetiaan lewat tindakan, bukan kata-kata.",
    innerConflict: "Antara keyakinan lama bahwa tindakan sepihak (bahkan kekerasan) bisa jadi solusi atas ketidakadilan, melawan kesadaran baru bahwa itu mungkin cuma mengulang siklus kekerasan yang sama dalam skala yang lebih kecil.",
    values: "Tindakan nyata jauh lebih bermakna daripada niat baik yang berhenti di level wacana — tapi dia juga belajar mengenali batas moral dari tindakan sepihak, dan menolak godaan mengulanginya dengan kekuasaan yang lebih besar.",
    certainty: "canon"
  },
  "canto3": {
    ...
    traits: "Ceria dan hangat di permukaan, tapi menyembunyikan ketakutan yang sangat dalam. Sangat rentan terhadap manipulasi emosional karena diam-diam haus akan penerimaan dan perasaan dimengerti sepenuhnya.",
    towardOthers: "Berbeda dari sikapnya ke keluarganya sendiri, Sinclair cenderung lebih jujur soal emosinya di depan sesama Sinner — dia dan Dante sama-sama terlihat ngeri saat menyaksikan cara bus mereka 'diberi makan' Enkephalin di Canto I, tanpa berusaha menutupinya.",
    relationships: "Momen paling mengungkap dirinya justru datang lewat permintaan tak terduga: diminta menari memakai maracas oleh Los Mariachis di Canto II, sebuah tarian yang secara tidak sengaja membongkar kegelapan yang selama ini dia represi. Konflik utamanya bukan dengan sesama Sinner, melainkan dengan manipulasi dari pihak luar (Kromer).",
    innerConflict: "Antara menjaga citra 'baik-baik saja' demi terus diterima orang-orang di sekitarnya, melawan kebutuhannya sendiri untuk jujur mengakui ketakutan mendalam soal kehilangan identitas lewat penggantian tubuh penuh.",
    values: "Kecurigaan yang sehat terhadap 'kemajuan' yang dirayakan tanpa kritik — keberanian untuk meragukan arus utama, meski itu membuatnya terlihat aneh atau tidak bersyukur di mata orang lain.",
    certainty: "canon"
  },
  "canto4": {
    ...
    traits: "Pasif dan mudah mengalah pada keinginan orang lain, seorang jenius kreatif (pencipta teknologi Cermin) yang menyimpan kesepian mendalam di balik kepandaiannya. Cenderung memendam keputusasaan alih-alih menyuarakannya.",
    towardOthers: "Yi Sang sangat mengandalkan validasi dari orang di sekitarnya — dia butuh Dante mengonfrontasinya secara langsung sebelum akhirnya berani jujur soal perasaannya sendiri. Di tengah tim, dia lebih sering mengikuti arah orang lain daripada mengambil keputusan sendiri.",
    relationships: "Hong Lu-lah yang berinisiatif meminta Dante bicara langsung dengannya di titik terendahnya — tanda bahwa ada Sinner lain yang diam-diam mengamati dan peduli pada kondisi mentalnya. Justru di momen paling krusial, dia dihibur oleh Sang Yi, versi 'ideal' dari dirinya sendiri, bukan oleh sesama Sinner.",
    innerConflict: "Antara keputusasaan pasif yang membuatnya diam-diam ingin 'beristirahat abadi', melawan keinginan untuk hidup demi idealnya sendiri, bukan lagi demi diterima atau divalidasi oleh siapa pun.",
    values: "Idealisme sejati harus dipilih untuk diri sendiri, bukan demi validasi dari luar — sayap yang selama ini dia iri-irikan dari orang lain sebenarnya sudah lama menjadi miliknya sendiri, tinggal diakui.",
    certainty: "canon"
  },
  "canto5": {
    ...
    traits: "Skeptis dan menjaga jarak emosional sebagai bentuk perlindungan diri, mudah diliputi keraguan diri akibat trauma lama bersama Ahab, tapi menyimpan kompas moral yang kuat begitu dia berani mempercayainya lagi.",
    towardOthers: "Awalnya menolak bekerja sama dengan tim kecuali diperintah langsung — sikap defensif yang lahir dari trauma terhadap otoritas dan kepercayaan yang pernah dikhianati Ahab. Sikap ini perlahan mencair lewat dukungan konsisten dari Dante dan Heathcliff.",
    relationships: "Diselamatkan langsung oleh Heathcliff dari Palidifikasi yang nyaris menelan dirinya utuh; dipandu Dante untuk menentukan arahnya sendiri, alih-alih dibiarkan sendirian menghadapi bayang-bayang mentornya. Dua bentuk dukungan tim yang jadi titik balik penting baginya.",
    innerConflict: "Antara keinginan lama untuk menjadi seperti Ahab, mentor yang pernah begitu dia kagumi, melawan kesadaran baru bahwa itu hanya akan mengulang kehancuran yang sama seperti yang menimpa krunya dulu.",
    values: "Kompas moral harus ditentukan sendiri, bukan diwariskan begitu saja dari sosok yang pernah dikagumi — bahkan kalau itu berarti harus melepaskan idola yang pernah membentuk seluruh arah hidupnya.",
    certainty: "canon"
  },
  "canto6": {
    ...
    traits: "Keras kepala dan menjaga harga diri meski terus-menerus direndahkan, menyimpan cinta yang tidak pernah padam meski diperlakukan buruk selama bertahun-tahun. Cenderung defensif dan sarkastik begitu masa lalunya disinggung.",
    towardOthers: "Di balik sikap dinginnya, dia diam-diam dihargai penuh oleh rekan setimnya sendiri — sesuatu yang jarang dia rasakan di luar LCB. Reaksinya terhadap perhatian itu biasanya berupa canggung menerima, bukan menolak.",
    relationships: "Sebelum turun dari bus, Rodion dan Hong Lu menghias penampilannya dengan pakaian mewah agar terlihat pantas di hadapan Catherine — bentuk kepedulian kecil yang kontras dengan penghinaan yang selalu dia terima di Wuthering Heights. Vergilius bahkan rela melanggar kontraknya sendiri demi menyelamatkan Heathcliff dan tim dari Wild Hunt.",
    innerConflict: "Antara dendam dan duka mendalam atas kehilangan Catherine untuk selamanya, melawan pilihannya sendiri untuk tetap menegakkan kepala dan terus melangkah maju, alih-alih tenggelam dalam kepahitan seumur hidup.",
    values: "Martabat diri tidak ditentukan oleh bagaimana orang lain memperlakukanmu, melainkan oleh bagaimana kau memilih meresponsnya — sebuah keyakinan yang membuatnya berkembang jauh lebih jauh dibanding orang-orang yang dulu merendahkannya.",
    certainty: "canon"
  },
  "canto7": {
    ...
    traits: "Bertindak dari hati dan dorongan spontan, kadang tanpa berpikir panjang soal akibatnya. Awalnya menjalani identitas 'Don Quixote' sebagai kewajiban yang terpaksa dipikul, penuh keraguan diri di baliknya.",
    towardOthers: "Impulsivitasnya kadang membuat tim harus menanggung akibatnya — seperti saat dia mencoba mencegah petugas perbatasan memisahkan sebuah keluarga di Canto III, yang berujung pertarungan besar. Meski begitu, dorongan itu selalu lahir dari niat baik, bukan kecerobohan tanpa alasan.",
    relationships: "Vergilius menegurnya keras atas tindakan gegabahnya, tapi tim tetap mendukungnya sesudahnya. Faust bahkan berjanji akan mengambil tanggung jawab penuh untuknya, seandainya Sancho suatu hari mengetahui seluruh rencana P Corp terhadap ayahnya sendiri — bentuk perlindungan diam-diam dari sesama Sinner.",
    innerConflict: "Antara memakai nama dan mimpi ayahnya karena keterpaksaan semata, melawan proses panjang untuk akhirnya memilihnya secara sadar dan penuh keyakinan sebagai miliknya sendiri.",
    values: "Mimpi yang terasa 'mustahil' tetap layak diperjuangkan — bukan karena naif atau tidak sadar risikonya, melainkan justru karena dipilih secara sadar dan penuh keyakinan pribadi.",
    certainty: "canon"
  },
  "canto8": {
    ...
    traits: "Tampak tenang dan dingin di permukaan sebagai hasil dari menekan emosi secara total — mekanisme bertahan yang dia bangun sejak kecil setelah menyaksikan kekerasan yang tak mampu dia cegah.",
    towardOthers: "Meski menekan perasaannya sendiri, Hong Lu justru jeli mengamati kondisi mental rekan setimnya — dialah yang berinisiatif meminta Dante mengonfrontasi Yi Sang secara langsung di Canto IV, sebuah bentuk kepedulian yang disalurkan lewat tindakan, bukan ungkapan emosi terbuka.",
    relationships: "Hubungan keluarganya sendiri jauh lebih rumit daripada dengan sesama Sinner: kakaknya, Jia Huan, justru jadi antagonis yang berulang kali muncul mengejar kekuatan Abnormality, sementara adiknya, Jia Xichun, sempat mengkritiknya karena dianggap tidak punya kehendak bebas sendiri.",
    innerConflict: "Antara kepasifan sebagai 'saksi yang menyerah' — sebuah cara bertahan yang terasa aman jangka pendek — melawan keberanian yang akhirnya tumbuh untuk bertindak langsung melawan sistem kekerasan yang diwariskan keluarganya sendiri.",
    values: "Kepasifan bukanlah kedamaian, hanya penundaan dari rasa sakit yang sama — dan keberanian sejati bukan soal tidak merasa takut sama sekali, melainkan soal tetap bertindak meski rasa takut itu masih ada.",
    certainty: "canon"
  },
  "canto9": {
    ...
    traits: "Digambarkan sebagai 'sinner tergelap' di antara semuanya, tetapi menyimpan sisi lembut yang jarang ditunjukkan — kehilangan besar di masa kecilnya membentuknya jadi sosok yang sangat protektif terhadap satu-satunya orang yang masih tersisa baginya.",
    towardOthers: "Sisi ringan dan jenaka dari Ryoshu justru muncul di Intervallo I, saat dia berinteraksi santai dan kompetitif dengan Gregor dalam sebuah kompetisi memasak — kontras dengan beban berat yang membayangi Canto-nya sendiri.",
    relationships: "Ikatan yang paling membentuk dirinya justru terjalin dengan tokoh-tokoh di luar tim inti LCB: putrinya, Araya, yang jadi satu-satunya benang penghubung ke masa lalunya, dan Rien, sosok yang dulu menciptakan jarak namun akhirnya meminta maaf di detik-detik terakhir.",
    innerConflict: "Antara obsesi diam-diam terhadap kesempurnaan — mirip dengan pelukis Yoshihide yang menginspirasinya — melawan kebutuhannya untuk menerima kejujuran emosional yang datang terlambat dari orang yang pernah menyakitinya.",
    values: "Kejujuran emosional yang murni sering kali baru muncul ketika semuanya sudah terlambat, tetapi itu tidak pernah membuatnya menjadi kurang bermakna — dan menjauh 'demi kebaikan orang lain' sering kali sebenarnya cuma jalan pintas untuk menghindari kehadiran yang jujur dan rentan.",
    certainty: "canon"
  }
};
